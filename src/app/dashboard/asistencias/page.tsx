...
export default function AsistenciasPage() {
  ...
  // Calcular asistencias para la página actual
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentAsistencias = asistenciasFiltradas.slice(indexOfFirstItem, indexOfLastItem);
              ...
              <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">
                      {Math.min(indexOfLastItem, asistenciasFiltradas.length)}
                    </span>{' '}
                    de <span className="font-medium">{asistenciasFiltradas.length}</span> asistencias
                  </p>
                </div>
                <div>
